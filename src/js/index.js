...
const personagens = document.querySelectorAll('.personagem') // passo 1 - pegar os personagens no JS pra poder verificar quando o usuário passar o mouse em cima de um deles
